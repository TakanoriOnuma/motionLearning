...
cd sprintf("%s/outNeuron/%s/%d/view%d,%d", path, subDirName, swingNum, x, y)
...
splot sprintf("%s/middle/%s/%d/middle%d.dat", path, subDirName, swingNum, n) w lp lw 2 title "locus"
...
# nがlimitに達したらswingNumを+1にしてnを元に戻す
if (n > limit) \
